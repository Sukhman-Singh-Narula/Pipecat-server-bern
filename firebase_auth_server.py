#!/usr/bin/env python3
"""
Authentication Test Server with Firebase
"""
import sys
import os
import asyncio
...
app = FastAPI(title="ESP32 Authentication Server", version="1.0.0")
...
async def root():
    ...
    return {
        "message": "ESP32 Authentication Server is running",
        "status": "healthy",
        "firebase_enabled": auth_service.firebase.use_firebase,
        "collections": {
            "claim_tokens": auth_service.claim_tokens_collection,
            "device_registrations": auth_service.device_registrations_collection,
            "device_sessions": auth_service.device_sessions_collection,
            "user_device_bindings": auth_service.user_device_bindings_collection
        }
    }
...
if __name__ == "__main__":
    logger.info("🔥 Starting ESP32 Authentication Server with Firebase...")
    logger.info(f"🔥 Firebase enabled: {auth_service.firebase.use_firebase}")
